...
plot_fourier_coeffs(coeffs, "Fourier Coefficients for Learning $\chi_{1:"+str(d)+"}$", "upper left",[-0.1,0.50],[0,100000],'--')
datasetname = 'stair5_biased'
(iter_range, coeffs) = pickle.load(open('trained_wts/' + datasetname + '/coeffs.pkl','rb'))
plot_fourier_coeffs(coeffs, "Fourier Coefficients for Learning $S_{"+str(d)+"}$", "lower right",[0.0,0.45],[0,60000],'--')
