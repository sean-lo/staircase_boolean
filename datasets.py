...
class UnbiasedBooleanDataset(BooleanDataset):
    def __init__(self, n: int, eval_fn):
        gen_fn = generate_boolean_unbiased
        super().__init__(n, gen_fn, eval_fn)


class UnbiasedERMBooleanDataset(ERMBooleanDataset):
    def __init__(
        self,
        n: int,
        eval_fn,
...
class BiasedBooleanDataset(BooleanDataset):
    def __init__(self, n: int, p: float, eval_fn):
        gen_fn = functools.partial(generate_boolean_biased, p=p)
        super().__init__(n, gen_fn, eval_fn)


class BiasedERMBooleanDataset(ERMBooleanDataset):
    def __init__(
        self,
        n: int,
        p: float,
...
class GaussianBooleanDataset(BooleanDataset):
    def __init__(self, n: int, eval_fn):
        gen_fn = generate_gaussian
        super().__init__(n, gen_fn, eval_fn)


class GaussianERMBooleanDataset(ERMBooleanDataset):
    def __init__(
        self,
        n: int,
        eval_fn,
